...
## 📅 راهنمای عملیاتی تقویم رسمی ایران

برای نگهداری، اعتبارسنجی، import و کنترل صحت تقویم رسمی ایران در سامانه، فایل زیر را مطالعه کنید:

```text
docs/calendar-operations.md
```

این مستند شامل روند import سال جدید، validation، smoke testها، SQLهای کنترل دیتابیس، rollback امن و قوانین معماری استفاده از Calendar DB است.
