            ...
            <table className="w-full min-w-[980px] border-separate border-spacing-0 text-right text-sm">
              <thead>
                <tr className="bg-white/5 text-zinc-200">
                  <th className="sticky right-0 z-30 min-w-[220px] border-b border-white/10 bg-white/10 p-3 text-right">
                    کاربر
                  </th>
              ...
              <tbody>
                {users.map((user) => (
                  <tr key={user.id} className="odd:bg-white/[0.03] align-top">
                    ...
                    <td className="border-b border-white/10 p-3">
                      <span
                        className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${user.role === UserRole.ADMIN ? "bg-amber-400/20 text-amber-100" : "bg-sky-400/20 text-sky-100"}`}
                      >
                    ...
                    <td className="border-b border-white/10 p-3">
                      <span
                        className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${user.isActive ? "bg-emerald-400/20 text-emerald-100" : "bg-zinc-500/25 text-zinc-200"}`}
                      >
                    ...
                    <td className="border-b border-white/10 p-3">
                      <form action={updateUserStatusAction}>
                        ...
                        <PendingSubmitButton
                          ...
                          className={`rounded-xl px-3 py-2 text-xs font-semibold transition ${user.isActive ? "bg-rose-500/20 text-rose-100 hover:bg-rose-500/30" : "bg-emerald-500/20 text-emerald-100 hover:bg-emerald-500/30"}`}
                        >
                    ...
                    <td className="border-b border-white/10 p-3">
                      ...
                      >
                        ...
                        <PendingSubmitButton
                          ...
                          className="rounded-xl bg-zinc-50 px-3 py-2 text-xs font-semibold text-zinc-950 transition hover:bg-zinc-200"
                        >
                          ثبت
                        </PendingSubmitButton>
                      </form>
